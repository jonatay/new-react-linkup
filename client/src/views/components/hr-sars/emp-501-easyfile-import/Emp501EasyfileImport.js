...
class Emp501EasyfileImport extends React.Component {
  state = {
    fileList: [],
    uploading: false,
  };
  ...
  render() {
    ...
    return (
      <Modal
        title="Import Easyfile Recon Return"
        ...
        <Row type="flex" justify="start" align="top">
          <Col span={24}>
            ...
            >
              ...
              >
                Must be csv files exportef from by SARS Easfile Employer.
              </p>
            </Dragger>
          </Col>
        </Row>
