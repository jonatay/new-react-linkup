...
import AttendLogFilter from "../../../components/attend/attend-log-filter";
import AttendLogTable from "../../../components/attend/attend-log-table";
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(AttendPage)
);
