...
router.get(
  "/transaction-type-cost-centres",
  transactionTypeCostCentreController.list
);
router.put(
  "/transaction-type-cost-centres/:id",
  transactionTypeCostCentreController.update
);
router.post(
  "/transaction-type-cost-centres/",
  transactionTypeCostCentreController.create
);
router.delete(
  "/transaction-type-cost-centres/:id",
  transactionTypeCostCentreController.delete
);
