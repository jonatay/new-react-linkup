import { apiFetch, apiInsert, apiRemove, apiUpdate, statusHelper, apiCustom, apiPdf } from './api-fetch';
...
export class ApiList {
	...
	getPdf(params, action) {
		return apiPdf(this.path, action, params, this.token)
			...
			.then(
				response => URL.createObjectURL(new Blob([response], { type: 'application/pdf' }))
