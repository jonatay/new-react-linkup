...
export const getSageBatchInstructions = () => ['Update', 'PaySalaries', 'DatedSalaries', 'Realtime', 'DatedPayments'];
...
export const getSageBatchById = createSelector(getSageBatchList, (list, id) => list.filter(rec => rec.id === id));

export const getSageBatches = createSelector(getSageBatchList, sageBatchList => sageBatchList.toArray());
