...
export const getSageBBranchById = createSelector(getSageBBranchList, (list, id) => list.filter(rec => rec.id === id));

export const getSageBBranches = createSelector(getSageBBranchList, getSageBanks, (sageBBranchList, sageBanks) =>
