...
export const getCostCentreGroupById = createSelector(getCostCentreGroupList, (list, id) =>
	list.filter(rec => rec.id === id)
);

export const getCostCentreGroups = createSelector(getCostCentreGroupList, list => list.toArray());
