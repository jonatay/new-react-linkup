...
export const getTransactionTypeById = createSelector(getTransactionTypeList, (list, id) =>
	list.filter(rec => rec.id === id)
);

export const getTransactionTypes = createSelector(getTransactionTypeList, list => list.toArray());
