...
export const getCostCentreById = createSelector(getCostCentreList, (list, id) => list.filter(rec => rec.id === id));

export const getCostCentres = createSelector(getCostCentreList, getTranTypeCcs, (list, ttccl) =>
	list.toArray().map(cc => ({
		...cc,
