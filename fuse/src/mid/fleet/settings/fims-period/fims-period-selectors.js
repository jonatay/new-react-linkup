...
export const getFimsPeriodById = createSelector(getFimsPeriodList, (list, id) => list.filter(rec => rec.id === id));

export const getFimsPeriods = createSelector(getFimsPeriodList, list => list.toArray());
