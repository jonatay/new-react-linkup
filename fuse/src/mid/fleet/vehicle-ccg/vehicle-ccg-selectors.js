...
export const getVisibleVehicleCcgs = createSelector(getVehicleCcgsList, vehicleCcgList => vehicleCcgList);

export const getVehicleCcgById = createSelector(getVehicleCcgsList, (vehicleCcgList, id) =>
...
export const getVehicleCcgList = createSelector(
	...
	(vehicleCcgList, costCentreGroups) =>
		vehicleCcgList.map(vccg => ({
			...vccg,
			cost_centre_group: costCentreGroups.find(ccg => ccg.id === vccg.cost_centre_group_id)
		}))
);
