...
export const getVehicleDriverById = createSelector(getVehicleDriverList, (list, id) =>
	list.filter(rec => rec.id === id)
);

export const getVehicleDrivers = createSelector(getVehicleDriverList, list => list.toArray());
