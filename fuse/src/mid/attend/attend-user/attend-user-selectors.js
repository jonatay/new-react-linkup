...
export const getAttendUserById = createSelector(getAttendUserList, (list, id) => list.filter(rec => rec.id === id));

export const getAttendUsers = createSelector(getAttendUserList, list => list.toArray());

export const getAttendUsersWithDept = createSelector(getAttendUserList, getAttendDepts, (users, depts) =>
	users
		.map(user => ({
			...user,
