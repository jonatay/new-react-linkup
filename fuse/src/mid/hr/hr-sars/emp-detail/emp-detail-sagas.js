...
function* createEmpDetail({ payload: { empDetail } }) {
	const result = yield call([empDetailList, empDetailList.insert], {
		empDetail
	});
...
function* updateEmpDetail({ payload: { id, changes } }) {
	const result = yield call([empDetailList, empDetailList.update], id, {
		changes
	});
...
function* removeEmpDetail({ payload: { empDetail } }) {
	const result = yield call([empDetailList, empDetailList.remove], empDetail.id);
...
function* importEmpEasyfile({ payload: { data } }) {
	const result = yield call([empDetailList, empDetailList.importEmpEasyfile], {
		data
	});
