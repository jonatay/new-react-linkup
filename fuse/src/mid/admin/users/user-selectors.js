...
export const getVisibleUsers = createSelector(getUserList, userList => userList);

export const getUserById = createSelector(getUserList, (userList, uid) => userList.filter(user => user.uid === uid));
