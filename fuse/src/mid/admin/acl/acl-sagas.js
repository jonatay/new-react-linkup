...
import { call, take, takeEvery, put, fork, cancel, race } from 'redux-saga/effects';
...
function* removeResource({ payload }) {
	console.log(payload);
	const result = yield call([aclApi, aclApi.aclRemoveResource], payload);
