...
import NavbarLayoutLinkup from './NavbarLayoutLinkup';
...
function NavbarWrapperLayoutLinkup(props) {
			...
			<ThemeProvider theme={navbarTheme}>
				<div id="fuse-navbar" className={clsx(classes.wrapper, folded && classes.wrapperFolded)}>
					<Hidden mdDown>
						...
						>
							<NavbarLayoutLinkup className={classes.navbarContent} />
						</div>
					</Hidden>
...
export default React.memo(NavbarWrapperLayoutLinkup);
